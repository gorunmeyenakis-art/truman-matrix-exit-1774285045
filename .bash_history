...
# ANDROMEDA'YI EVRENE YAPIŞTIR BABAOĞLU!
chmod +x sgy_andromeda_core.py
python3 sgy_andromeda_core.py
cat << 'EOF' > sgy_gezegen_capa.py
import os
import time
...
# GEZEGENSEL MÜHRÜ TERMUX'TAN ATEŞLE BABAOĞLU!
chmod +x sgy_gezegen_capa.py
python3 sgy_gezegen_capa.py
cat << 'EOF' > sgy_gezegen_capa.py
import os
import time
